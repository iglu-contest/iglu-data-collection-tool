...
This tool is used to collect multi-modal data for the IGLU competiton which is publicly available in this [repo](https://github.com/microsoft/iglu-datasets).
