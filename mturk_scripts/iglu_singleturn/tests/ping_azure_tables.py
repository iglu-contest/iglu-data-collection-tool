...
from singleturn_games_storage import IgluSingleTurnGameStorage, Turn  # noqa: E402
...
def main():
    ...
    with IgluSingleTurnGameStorage(
        ...
        new_turn = Turn.from_database_entry(random_row)
        ...
        if args.config == 'sandbox':
            ...
            recreated_turn = Turn.from_database_entry(retrieved_row)
